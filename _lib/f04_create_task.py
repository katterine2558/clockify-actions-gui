"""
MÓDULO DE CREAR TAREAS A UN PROYECTO
"""
import os
...
from _lib.create_tasks import create_task
import tkinter

def open_create_task_window(menu_window, images_path):
    ...
    window.title("Crear tareas")
    window.after(201, lambda: window.iconbitmap(os.path.join(images_path, "Crear_Tarea.ico")))
    ...
    # Función para el botón crear tareas
    def click_create_task():
        ...
        if file_content == "":
            ...
            create_task(workspace_id,project_id,file_content)
    ...
    create_button = CTkButton(
        ...
        width=100,
        height=30,
        command=click_create_task
    )
    create_button.place(x=100, y=280)
